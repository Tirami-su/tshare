...
其中关注，失物招领，拼客，表白，上架，收购以瀑布流形式在页面左侧展示，宽占2/3，时间倒序无限刷
...
平台接受文件后根据规则自动重命名，比如 2019春_软件工程_课件_第一章,如果上传文件夹的压缩包，自动对文件夹整理，添加或删去一些子文件夹，重新安排文件的目录，重新命名

平台对所有文件添加标签

搜索文件后显示资料列表，包括文件和文件夹，每一项包括名称，标签，下载量，顶/踩，上传日期，大小，还有预览和下载按钮
